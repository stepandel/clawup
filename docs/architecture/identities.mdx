...
Clawup discovers identities from local directories (subdirectories containing `identity.yaml`) or Git repos. See the [example identity](https://github.com/stepandel/clawup/tree/main/examples/identity) for a minimal starting point, or the [multi-agent example](https://github.com/stepandel/clawup/tree/main/examples/multi-agent) for a complete 3-agent fleet with cross-agent ticket workflows.
...
To create an agent with a completely custom role, create a new identity directory. See the [example identity](https://github.com/stepandel/clawup/tree/main/examples/identity) for a minimal starting point, the [multi-agent example](https://github.com/stepandel/clawup/tree/main/examples/multi-agent) for a production fleet, or the [Creating Identities](/guides/creating-identities) guide for a full walkthrough.
