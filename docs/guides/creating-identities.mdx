...
<Tip>
The fastest way to get started is to copy the [example identity](https://github.com/stepandel/clawup/tree/main/examples/identity) and modify it for your use case. For a complete multi-agent deployment with cross-agent workflows, see the [multi-agent example](https://github.com/stepandel/clawup/tree/main/examples/multi-agent).
</Tip>
...
- **Start with an example.** Copy `examples/identity/` for a single agent, or `examples/multi-agent/` for a full PM + Engineer + Tester fleet.
