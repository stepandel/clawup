...
<Tip>
The `clawup init` wizard copies the correct manifest to your clipboard automatically when you reach the Slack setup step.
</Tip>
...
The `clawup init` wizard prompts for both tokens per agent:
